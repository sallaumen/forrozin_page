defmodule ForrozinWeb.AdminBackupsLiveTest do
  @moduledoc """
  ...
  describe "format_size/1" do
    test "formats bytes under 1 KB" do
      assert ForrozinWeb.AdminBackupsLive.format_size(512) == "512 B"
    end

    test "formats kilobytes" do
      assert ForrozinWeb.AdminBackupsLive.format_size(2048) == "2.0 KB"
    end

    test "formats megabytes" do
      assert ForrozinWeb.AdminBackupsLive.format_size(2_097_152) == "2.0 MB"
    end
  end
  ...
  describe "format_timestamp/1" do
    test "formats a valid NaiveDateTime" do
      ...
      assert ForrozinWeb.AdminBackupsLive.format_timestamp(dt) == "15/04/2026 às 12:00:00"
    end

    test "returns fallback for nil" do
      assert ForrozinWeb.AdminBackupsLive.format_timestamp(nil) == "Data desconhecida"
    end
  end
end
