defmodule Mix.Tasks.OGrupoDeEstudos.ExtractConnections do
  ...
  ## Usage
      ...
      mix o_grupo_de_estudos.extract_connections
  ...
  def run(_args) do
    ...
    Mix.shell().info("\nDone. Run `mix o_grupo_de_estudos.restore_backup` to save a backup.")
  end
