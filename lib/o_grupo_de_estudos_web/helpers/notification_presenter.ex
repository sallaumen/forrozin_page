defmodule OGrupoDeEstudosWeb.Helpers.NotificationPresenter do
  ...
  defp action_phrase(:workshop_enrolled, false), do: " se inscreveu no seu workshop"
  defp action_phrase(:workshop_enrolled, true), do: " se inscreveram no seu workshop"
  defp action_phrase(:workshop_commented, false), do: " comentou no seu workshop"
  ...
  defp action_phrase(:workshop_invited, _), do: " te convidou para um workshop"
