defmodule OGrupoDeEstudosWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: OGrupoDeEstudosWeb.Gettext
  ...
  def flash(assigns) do
    ...
    >
      <.icon
        ...
        class="size-5 shrink-0 mt-0.5 text-accent-green"
      />
      <.icon
        :if={@kind == :error}
      ...
      <button
        type="button"
        class="shrink-0 text-ink-500 hover:text-ink-900 transition-colors"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(OGrupoDeEstudosWeb.Gettext, "errors", msg, opts)
    end
  end
